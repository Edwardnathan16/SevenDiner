...
class OwnerGetAverageSpendPerDayController{

    GetAverageSpendPerDay(req, res) {
        let order = new Order(); 
        var datePerDay = req.body.datePerDay;


        order.GetAverageSpendPerDay(datePerDay, function(orderDetails, result){
...
exports.OwnerGetAverageSpendPerDayController = OwnerGetAverageSpendPerDayController;