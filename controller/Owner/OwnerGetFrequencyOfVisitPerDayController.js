...
class OwnerGetFrequencyOfVisitPerDayController{

    GetFrequencyOfVisitPerDay(req, res) {
        let order = new Order(); 
        var datePerDay = req.body.datePerDay;


        order.GetFrequencyOfVisitPerDay(datePerDay, function(result){
...
exports.OwnerGetFrequencyOfVisitPerDayController = OwnerGetFrequencyOfVisitPerDayController;